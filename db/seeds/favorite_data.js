  ...
  await knex('FAVORITE').insert([
    {
      ...
      car: ['猿投グリーンロード「力石IC」から約15分', '東海環状自動車道「豊田勘八IC」から約20分'],
    },
    {
      user_id: 1,
      title: '名古屋城',
      ...
      publicTransport: JSON.stringify([
    ...
    },
    {
      ...
      title: '刈谷ハイウェイオアシス',
      prefecture: '愛知県',
      images: JSON.stringify(['https://anniversarys-mag.jp/img/p/pixta_44462056_M.jpg?w=730']),
      price: 0,
      access: '車',
      postCode: '448-0007',
